			...
			) )
		{
			if ( in_array( $input->get( "email" ), $userEmails ) ) {
				...
				$mailer->setEmailBody( "
					...
					<br>
					<a href='develop.jiujitsuscout.stupidsimple.com/account-manager/password-reset-validation?reset_token={$nonceToken->value}'>localhost/develop.jiujitsuscout.com/account-manager/password-reset-validation?reset_token={$nonceToken->value}</a>
					<br><br>
