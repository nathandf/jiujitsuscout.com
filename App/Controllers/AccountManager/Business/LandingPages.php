...
class LandingPages extends Controller
{
  ...
  public function indexAction()
  {
    ...
    $this->view->assign( "pages", $landingPages );

    $this->view->setTemplate( "account-manager/business/landing-pages/home.tpl" );
    $this->view->render( "App/Views/AccountManager/Business/LandingPages.php" );
  }
