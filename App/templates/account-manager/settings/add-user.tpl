	...
	<body>
		...
		<div class="con-cnt-xxlrg inner-box first">
			...
			<div class="encapsulation-cnt">
				<h2 class="h2 title-wrapper">Add new user</h2>
				...
				<form action="" method="post" id="add_user" >
					...
					<input type="text" class="inp field-med" id="contact" name="first_name" value="{$inputs.add_user.first_name|default:null}" placeholder="First name" />
					<div class="clear push-t-med"></div>
					<input type="text" class="inp field-med" id="contact" name="last_name" value="{$inputs.add_user.last_name|default:null}" placeholder="Last Name" />
					<div class="clear push-t-med"></div>
					<input type="text" class="inp field-med" id="email" name="email" value="{$inputs.add_user.email|default:null}" placeholder="Email" />
					<div class="clear push-t-med"></div>
					...
					<div class="clear push-t-med"></div>
					<input type="text" class="inp field-med" id="number" name="phone_number" value="{$inputs.add_user.phone_number|default:null}" placeholder="Phone Number" />
					<div class="clear push-t-med"></div>
					<p class="password_label">Assign an account role</p>
					<select name="role"class="inp field-med cursor-pt" id="">
					...
					<input type="submit" class="btn btn-cnt button-med" name="button"  value="Add User" color="white"/>
				</form>
			</div>
		</div>
	</body>
