	...
	<div class="con-cnt-xxlrg bg-white mat-box-shadow push-t-med">
		...
		<div class="inner-pad-med">
			...
			<form action="" method="post" id="add_user" >
				...
				<input type="text" class="inp" id="contact" name="first_name" value="{$inputs.add_user.first_name|default:null}" placeholder="First name" />
				<div class="clear push-t-med"></div>
				<input type="text" class="inp" id="contact" name="last_name" value="{$inputs.add_user.last_name|default:null}" placeholder="Last Name" />
				<div class="clear push-t-med"></div>
				<input type="text" class="inp" id="email" name="email" value="{$inputs.add_user.email|default:null}" placeholder="Email" />
				<div class="clear push-t-med"></div>
				...
				<div class="clear push-t-med"></div>
				<input type="text" class="inp" id="number" name="phone_number" value="{$inputs.add_user.phone_number|default:null}" placeholder="Phone Number" />
				<div class="clear push-t-med"></div>
				<p class="password_label">Assign an account role</p>
				<select name="role"class="inp cursor-pt" id="">
				...
				<input type="password" class="inp push-t-med" id="confirm_password" name="confirm_password" placeholder="Confirm new password" />
				<div class="clear push-t-med"></div>
