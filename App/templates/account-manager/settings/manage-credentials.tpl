	...
	<div class="con-cnt-xxlrg bg-white mat-box-shadow push-t-med">
		...
		<div class="inner-pad-med">
			...
			<form action="" method="post" id="submit-form" >
				...
				<input type="text" class="inp inp-med-plus-plus" id="email" name="email" value="{$inputs.update_password.email|default:null}" placeholder="Email" />
				<div class="clear push-t-med"></div>
				<input type="password" class="inp inp-med-plus-plus" id="password" name="password" placeholder="New password" />
				<div class="clear push-t-med"></div>
				<input type="password" class="inp inp-med-plus-plus" id="confim_password" name="confirm_password" placeholder="Confirm new password" />
				<div class="clear push-t-med"></div>
