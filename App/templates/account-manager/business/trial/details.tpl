	...
	<body>
		...
		<div class="con-cnt-xxlrg first inner-pad-med">
			...
			<form method="get" action="">
				...
				{html_select_date class="inp field-xsml-plus cursor-pt first" prefix='StartDate' start_year='-1' end_year='+3'}
				<div class="clear"></div>
				...
				<div id="trial-length" style="display: block;" class="trial-length">
					<h3>Trial Length</h3>
					<input id="quantity" type="quantity" class="inp field-xsml first" name="quantity" placeholder="Ex. 6"> <label for="quantity">Qty.</label>
				...
				<div id="specific-end-date" style="display: none;" class="end-date">
					<h3>End Date</h3>
					{html_select_date class="inp field-xsml-plus cursor-pt first" prefix='EndDate' start_year='-1' end_year='+3'}
					</select>
				</div>
