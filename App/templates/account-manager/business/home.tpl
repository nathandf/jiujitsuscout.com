...
<html>
	...
	<body>
	    ...
	    <div class="con-cnt-xxlrg">
			...
			<div class="con-half-min-320 cnt-640 push-t-med floatleft">
				<p class="text-center text-xlrg-heavy push-b-med">Lead Management</p>
			...
			<div class="con-half-min-320 cnt-640 push-t-med floatleft">
				<p class="text-center text-xlrg-heavy push-b-med">Marketing Management</p>
