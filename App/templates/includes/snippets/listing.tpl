<div class="listing">
	<div class="floatleft">
		...
		{foreach from=$business->disciplines item=discipline name="business_discipline_loop"}
			<span class="tc-gun-metal push-t-sml text-sml cursor-pt" style="border-radius: 2px; border: 1px solid #CCC; padding: 1px; box-sizing: border-box;">{$discipline->nice_name}</span>
		{/foreach}
		<div class="clear"></div>
	</div>
