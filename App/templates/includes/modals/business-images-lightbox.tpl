<div style="display: none; overflow-y: scroll;" class="lightbox business-images-lightbox inner-pad-med">
	...
	{foreach from=$images item=image name=image_loop}
		<img style="width: 90%; max-width: 600px; border: 1px solid #CCC; border-radius: 3px; background: #FFF; display: block; margin: 0 auto; margin-top: 20px;" src="{$HOME}public/img/uploads/{$image->filename}" alt="">
	{/foreach}
</div>
