<div id="new-task-modal" style="display: none; overflow-y: scroll;" class="lightbox inner-pad-med">
	...
	<div class="con-cnt-xlrg bg-white inner-pad-med border-std push-t-lrg">
		<p class="text-xlrg-heavy">New Task</p>
		...
		<form method="post" action="{$HOME}account-manager/business/task/new">
			...
			<div class="clear"></div>
			<input type="submit" class="btn btn-inline push-t-med task-submit" value="Create task">
		</form>
	</div>
</div>
