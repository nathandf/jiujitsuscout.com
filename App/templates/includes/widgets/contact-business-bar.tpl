<div style="padding: 20px 0px 20px 0px; border-top: 1px solid #CCCCCC; border-bottom: 1px solid #CCCCCC;">
	{if isset($is_registered)}
		{if isset($signed_up)}
		<p class="text-xlrg-heavy"><i aria-hidden="true" class="fa fa-check tc-white bg-good-green push-r-med" style="border-radius: 3px; padding: 3px;"></i>Successfully Registered</p>
		{else}
