<div id="insert-image-picker-modal" style="display: none; overflow-y: scroll;" class="lightbox inner-pad-med">
	...
	<div class="con-cnt-xlrg bg-white inner-pad-med">
		{foreach from=$images item="image"}
			<img class="insert-image-picker-image image-picker-image" data-id="{$image->id}" data-src="{$root|default:'https://www.jiujitsuscout.com'}public/img/uploads/{$image->filename}" src="{$HOME}public/img/uploads/{$image->filename}" alt="{$image->alt}">
		{foreachelse}
